...
export default function BookingsClient({
  ...
  const texts = {
    es: {
      ...
      availableRecords: "disponibles",
      pending: "Pendientes",
      needsFollowUp: "seguimiento",
      confirmed: "Confirmadas",
      activeStatus: "activas",
      paid: "Pagadas",
      closedBookings: "completadas",
      date: "Fecha",
      time: "Hora",
      status: "Estado",
      ...
      distinctBusinesses: "distintos",
      myRequestedAppointments: "solicitadas",
    ...
    en: {
      ...
      myRequestedAppointments: "requested",
