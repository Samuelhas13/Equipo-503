...
export class NotificationsController {
  ...
  @Get()
  @ApiOkResponse({ description: 'Obtener notificaciones del usuario autenticado', type: [Notification] })
  findAll(@Request() req) {
  ...
  @Patch(':id/read')
  @ApiOkResponse({ description: 'Marcar una notificación como leída', type: Notification })
